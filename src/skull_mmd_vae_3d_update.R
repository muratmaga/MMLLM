...
opre = paste0("models/autopointsupdate_softmax_176_weights_3d_checkpoints5_GPU",mygpu)
...
findpoints = deepLandmarkRegressionWithHeatmaps( unetLM, activation='softmax', theta=NA )
